...
import apatosaurus from "./images/apatosaurus.png";
import brachiosaurus from "./images/brachiosaurus.png";
import elasmosaurus from "./images/elasmosaurus.png";
import parasaurolophulus from "./images/parasaurolophus.png";
...
const App = () => {
  ...
  return (
    <div className="app">
      ...
      <ScoreBoard score={"Score: " + scoreDisplay} />
    </div>
  );
};
